...
package Plugins::CustomSkip::Settings;
...
sub name {
	return Slim::Web::HTTP::CSRF->protectName('PLUGIN_CUSTOMSKIP');
}

sub page {
	return Slim::Web::HTTP::CSRF->protectURI('plugins/CustomSkip/settings/basic.html');
}
