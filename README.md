...
<img src="screenshots/cs_repo_icon.png" align="right" width="80px">**Custom Skip** lets you set player-specific **rules** for when the current track or upcoming tracks in your playlist should be skipped and removed from the playlist **automatically**.<br>
Some features are not enabled by default.<br clear="right">

> [!TIP]
> The user interface and menus are here: `Home Menu > Extras > Custom Skip`
